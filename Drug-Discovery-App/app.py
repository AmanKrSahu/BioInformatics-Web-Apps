...
# Streamlit framework
st.title("Filtered FDA Approved Drugs by Lipinski's Rule-of-Five")
...
raw_html = mols2grid.display(
    ...
    tooltip=["generic_name", "smiles", "MW", "LogP", "NumHDonors", "NumHAcceptors"],
    gap = 5
)._repr_html_()
